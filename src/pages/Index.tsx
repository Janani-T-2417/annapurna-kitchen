...
const testimonials = [
  { name: "Lakshmi P.", city: "Hyderabad", text: "The Avakaya tastes exactly like my grandmother used to make. Pure nostalgia in every bite!", img: "https://i.pravatar.cc/100?img=47" },
  { name: "Ravi Teja", city: "Bengaluru", text: "Premium packaging, fresh produce and unbelievable taste. Annapurna is now a household staple.", img: "https://i.pravatar.cc/100?img=12" },
  { name: "Sneha R.", city: "Vijayawada", text: "Gongura prawn pickle is heavenly. You can taste the freshness and the love in every spoon.", img: "https://i.pravatar.cc/100?img=32" },
];

const faqs = [
  { q: "What is the shelf life of your products?", a: "Pickles last 6 months from manufacture; podi up to 4 months. Refrigerate after opening for best taste." },
  { q: "Do you ship across India?", a: "Yes. We ship pan-India within 3–6 business days via trusted courier partners." },
  { q: "Are your products preservative-free?", a: "Absolutely. We use only cold-pressed oils, rock salt and traditional spices — no chemicals, no preservatives." },
  { q: "How should I store my pickle?", a: "Use a dry spoon and keep the surface covered with a thin layer of oil. Store in a cool, dry place." },
  { q: "What's your return policy?", a: "If the product is damaged in transit, share an unboxing video within 24 hours for a free replacement." },
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container-x relative grid lg:grid-cols-2 gap-12 items-center min-h-[78vh] py-16">
        <div className="max-w-xl">
          ...
          >
            Prepared with love, tradition, and 100% natural ingredients —
            pickles, podi, sweets and snacks from the heart of Andhra Pradesh.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-foreground/70"><span className="font-semibold text-foreground">4.9/5</span> from 2,400+ happy families</p>
          </motion.div>
        </div>
  ...
  return (
    <section id="categories" className="section-pad spice-bg">
      <div className="container-x">
        <SectionTitle eyebrow="Shop by Tradition" title="Our Categories" description="From fiery pickles to festive sweets — a complete Andhra pantry, crafted in small batches." />
...
function FeaturedSection() {
  return (
    <section className="section-pad">
      <div className="container-x">
        <SectionTitle eyebrow="Bestsellers" title="Crowd Favourites" description="Hand-picked, family-tested recipes our customers reorder month after month." />
      ...
      <div className="container-x grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <div className="absolute -bottom-6 -right-6 rounded-3xl glass p-5 shadow-gold max-w-[60%]">
            ...
            <p className="text-xs text-muted-foreground mt-1">Three generations of Andhra recipes, one trusted brand.</p>
          </div>
        </motion.div>

        <div>
          <p className="text-[11px] uppercase tracking-[0.3em] gold-text font-bold">Our Story</p>
          <h2 className="mt-2 font-display text-4xl md:text-5xl">A Family Recipe, Perfected Over Generations</h2>
          <p className="mt-5 text-muted-foreground leading-relaxed">
            Annapurna Foods began in a sunlit kitchen in coastal Andhra, where mangoes were sliced
            at dawn, chillies were sun-dried on terraces, and gingelly oil came straight from the village ghani.
            Today we bring those same recipes to your home — unchanged, uncompromised, and full of love.
          </p>
          <ul className="mt-6 grid sm:grid-cols-2 gap-3">
            {["Hand-picked Andhra produce","Stone-ground masalas","Cold-pressed gingelly oil","Small-batch, hygienic packing"].map((x) => (
              <li key={x} className="flex items-center gap-2 text-sm">
                <span className="grid h-6 w-6 place-items-center rounded-full bg-primary/10 text-primary"><Leaf className="h-3.5 w-3.5" /></span>
                {x}
              </li>
            ))}
          </ul>
          <Link to="/about" className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:bg-gold hover:text-gold-foreground transition">
  ...
  return (
    <section id="faq" className="section-pad">
      <div className="container-x grid lg:grid-cols-[1fr_1.4fr] gap-12">
        <div>
          <SectionTitle eyebrow="FAQ" title="Questions, answered." align="left" description="Everything you need to know about our products, shipping and storage." />
        </div>
